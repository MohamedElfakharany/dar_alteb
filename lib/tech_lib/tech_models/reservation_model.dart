class TechReservationsModel {
  ...
  TechReservationsModel({this.status, this.message, this.data, this.extra});

  TechReservationsModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      data = <TechReservationsDataModel>[];
      json['data'].forEach((v) {
        data!.add(new TechReservationsDataModel.fromJson(v));
      });
    }
...
class TechReservationsDataModel {
  ...
  TechReservationsDataModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    patient =
